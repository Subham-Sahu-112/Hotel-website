...
const Pricing = () => {
  ...
  const filteredRates = selectedProperty === 'all' 
    ? roomRates 
      ...
      <div className="pricing">
        ...
        <div className="pricing-header">
          <div className="header-left">
            ...
            <p className="pricing-subtitle">Manage room rates, seasonal pricing, and special offers</p>
          </div>
                ...
                <div key={rate.id} className="rate-card">
                  ...
                  <div className="rate-pricing">
                    <div className="price-item">
                      ...
                      <span className="price-value">${rate.baseRate}/night</span>
                    </div>
                    <div className="price-item">
                      <span className="price-label">Weekend</span>
                      <span className="price-value">${rate.weekendRate}/night</span>
                    </div>
                    <div className="price-item">
                      <span className="price-label">Peak Season</span>
                      <span className="price-value">${rate.seasonalRate}/night</span>
                    </div>
                  </div>
        ...
        <div className="pricing-stats">
          <div className="stat-card">
            ...
            <div className="stat-info">
              <div className="stat-number">
                ${Math.round(roomRates.reduce((sum, rate) => sum + rate.baseRate, 0) / roomRates.length)}
              </div>
          ...
          <div className="stat-card">
            <div className="stat-icon">🎯</div>
            <div className="stat-info">
              <div className="stat-number">{specialOffers.filter(o => o.status === 'active').length}</div>
