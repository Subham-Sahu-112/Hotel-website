      ...
      <div className="ven-register-container">
        ...
        <div className="ven-register-header">
          ...
          <p className="ven-register-subtitle">
            Join thousands of hotel partners worldwide and start earning more revenue
            by listing your property on our platform.
          </p>
        </div>
        ...
        <div className="ven-register-form-container">
          <div className="ven-form-header">
            ...
            <p className="ven-form-subtitle">Fill out the form below to get started with your hotel listing</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="ven-register-form">
            ...
            <div className="ven-form-section">
              ...
              <div className="ven-form-grid">
                <div className="ven-form-group">
                  ...
                  <input
                    ...
                    className={`ven-form-input ${errors.businessName ? 'error' : ''}`}
                  />
                  {errors.businessName && <span className="ven-error-message">{errors.businessName}</span>}
                </div>
              ...
              <div className="ven-form-group">
                ...
                <textarea
                  ...
                  className={`ven-form-textarea ${errors.businessDescription ? 'error' : ''}`}
                  rows="4"
                />
                {errors.businessDescription && <span className="ven-error-message">{errors.businessDescription}</span>}
              </div>
            </div>
            ...
            <div className="ven-form-section">
              ...
              <div className="ven-form-grid">
                <div className="ven-form-group">
                  ...
                  <input
                    ...
                    className={`ven-form-input ${errors.contactName ? 'error' : ''}`}
                  />
                  {errors.contactName && <span className="ven-error-message">{errors.contactName}</span>}
                </div>
                ...
                <div className="ven-form-group">
                  ...
                  <input
                    ...
                    className={`ven-form-input ${errors.emailAddress ? 'error' : ''}`}
                  />
                  {errors.emailAddress && <span className="ven-error-message">{errors.emailAddress}</span>}
                </div>
              </div>
              ...
              <div className="ven-form-group">
                ...
                <input
                  ...
                  className={`ven-form-input ${errors.phoneNumber ? 'error' : ''}`}
                />
                {errors.phoneNumber && <span className="ven-error-message">{errors.phoneNumber}</span>}
              </div>
            </div>
            ...
            <div className="ven-form-section">
              ...
              <div className="ven-form-group">
                ...
                <input
                  ...
                  className={`ven-form-input ${errors.streetAddress ? 'error' : ''}`}
                />
                {errors.streetAddress && <span className="ven-error-message">{errors.streetAddress}</span>}
              </div>
              ...
              <div className="ven-form-grid form-grid-3">
                <div className="ven-form-group">
                  ...
                  />
                  {errors.city && <span className="ven-error-message">{errors.city}</span>}
                </div>
                ...
                <div className="ven-form-group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="12345"
                    className={`ven-form-input ${errors.postalCode ? 'error' : ''}`}
                  />
                  {errors.postalCode && <span className="ven-error-message">{errors.postalCode}</span>}
                </div>
              </div>
            </div>
            ...
            <div className="ven-form-section">
              ...
              <div className="ven-form-grid">
                <div className="ven-form-group">
                  <label htmlFor="businessRegistrationNumber" className="ven-form-label">
                  ...
                  <input
                    ...
                    className={`ven-form-input ${errors.businessRegistrationNumber ? 'error' : ''}`}
                  />
                ...
                <div className="ven-form-group">
                  ...
                  />
                  {errors.taxId && <span className="ven-error-message">{errors.taxId}</span>}
                </div>
              </div>
            </div>
              ...
              <div className="ven-form-grid">
                <div className="ven-form-group">
                  ...
                  <input
                    ...
                    className={`ven-form-input ${errors.password ? 'error' : ''}`}
                  />
                  {errors.password && <span className="ven-error-message">{errors.password}</span>}
                </div>
              ...
              <div className="checkbox-group">
                <div className="form-checkbox">
                  ...
                  <label htmlFor="acceptTerms" className="checkbox-label">
                    I accept the <a href="#" className="link">Terms and Conditions</a> <span className="required">*</span>
                  </label>
                ...
                <div className="form-checkbox">
                  ...
                  <label htmlFor="acceptPrivacy" className="checkbox-label">
                    I accept the <a href="#" className="link">Privacy Policy</a> <span className="required">*</span>
                  </label>
